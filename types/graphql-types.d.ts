...
export type FooterComponentQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'author' | 'email'>> }> };

export type HeaderComponentQueryVariables = Exact<{ [key: string]: never; }>;


export type HeaderComponentQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description'>> }> };

export type IndexPageQueryVariables = Exact<{ [key: string]: never; }>;


export type IndexPageQuery = { allMarkdownRemark: { edges: Array<{ node: (
...
export type ArticleTemplateQuery = { markdownRemark?: Maybe<(
...
export type CreatePagesQuery = { allMarkdownRemark: { nodes: Array<{ frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'slug'>> }> } };
